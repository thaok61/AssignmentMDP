...
class AnimalDetailsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animalDetailsAdapter = AnimalDetailsAdapter(animalDetailsViewModel.animals.value)
    }
    override fun onStart() {
        super.onStart()
        mainViewModel.setTitle("Animal Details")
        mainViewModel.setShowBackButton(true)
        mainViewModel.setCurrentTypeFabButton(0)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                launch {
                    animalDetailsViewModel.animals.collect {
                        animalDetailsAdapter.updateData(it)
                    }
                }
            }
